...
public final class SlimefunItemSetup {
    ...
    public static void setup(@Nonnull SlimefunPlugin plugin) {
        ...
        new ItemStack[] { SlimefunItems.MAGIC_LUMP_3, SlimefunItems.MAGICAL_GLASS, SlimefunItems.MAGIC_LUMP_3, SlimefunItems.FILLED_FLASK_OF_KNOWLEDGE, SlimefunItems.EARTH_RUNE, SlimefunItems.FILLED_FLASK_OF_KNOWLEDGE, SlimefunItems.MAGIC_LUMP_3, SlimefunItems.MAGICAL_GLASS, SlimefunItems.MAGIC_LUMP_3},
        false, false, "wise", 20)
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.NETHER_STAR), new ItemStack(Material.FEATHER), new ItemStack(Material.NETHER_STAR), new ItemStack(Material.INK_SAC), SlimefunItems.MAGICAL_BOOK_COVER, new ItemStack(Material.GLASS_BOTTLE), new ItemStack(Material.NETHER_STAR), new ItemStack(Material.WRITABLE_BOOK), new ItemStack(Material.NETHER_STAR)})
        .register(plugin);
